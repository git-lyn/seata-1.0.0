...
public class TransactionalTemplate {
    ...
    public Object execute(TransactionalExecutor business) throws Throwable {
        ...
        // 调用TransactionalExecutor 上一步传递进来的TransactionalExecutor
        //并且调用该匿名对象的getTransactionInfo获取全局事务注解信息
        ...
        try {
            ...
            Object rs = null;
            try {
                // 执行业务方法，也就是我们的orderServer的createOrder方法
                // Do Your Business
                rs = business.execute();
    ...
    private void beginTransaction(TransactionInfo txInfo, GlobalTransaction tx) throws TransactionalExecutor.ExecutionException {
        try {
            //空方法
            triggerBeforeBegin();
            //真正提交的方法GlobalTransaction 的默认类DefaultGlobalTransaction处理
